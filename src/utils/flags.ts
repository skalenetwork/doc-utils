...
const _handleValue = (args: string[], value: string, throwOnUndefined: boolean = false) : string | undefined => {
...
export const sortFlags = (args: string[]) : Flags => {
    return {
        ...
        uiRepo: _handleValue(args, "--ui-repo") ?? "https://github.com/skalenetwork/doc-ui",
